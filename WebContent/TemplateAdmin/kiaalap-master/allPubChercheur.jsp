                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            <h4>Liste des publications d'un chercheur :</h4>
                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>${q.getType_publication()}</td>
                                        <td>${q.getDate_publication()}</td>
                                       
                                        <td>${q.getPdfPub()}</td>
                                        <td>${q.getJustificatif_pub()}</td>
                                       
                                         <td>
                                       
                                        <a href ="deleteChercheurPub.php?id_chercheur=${q.getId_chercheur()}">
