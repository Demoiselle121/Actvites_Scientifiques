                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            <h4>Liste des chercheurs par equipe</h4> 
								
                           		     
                                                                <a href ="ChercheurParEquipe.php">
                           ...
                           <!--   <form action ="updateChercheurEquipe.php" method = "post">-->
                              <div class="asset-inner">
                                <table>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <a href ="deleteChercheurEquipe.php?id_chercheur=${q.getId_chercheur()}">
    ...
    <div class="product-status mg-b-15">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            <h4>Liste des axes par equipe</h4> 
								
                           		     
         <a href ="allChercheurEquipe.php">
         <button type="submit" class="btn btn-primary waves-effect waves-light">PDF</button>
           </a>
                           ...
                           <!--   <form action ="updateChercheurEquipe.php" method = "post">-->
                              <div class="asset-inner">
                                <table>
                                    <tr>
                                        <th style = "width:10%">No</th>
                                        <th style = "width:10%">Axe de recherche</th>
                                    ...
                                    <tr>
                                        ...
                                        <a href ="deleteAxeEquipe.php?id_axe=${a.getId_axe()}">
                                            <button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                       </a>
