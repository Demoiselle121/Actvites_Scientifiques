                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                               <li><a href="all-encadrement.jsp">Tous les Encadrements</a>
                                                ...
                                                <li><a href="addEncadrement.php">Ajouter Encadrement</a>
                                                </li>
                                ...
                                <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                    <form action="ajouterAUneEquipe1.php" method = "post" >
                                                        <div class="row">
                                                             <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group" >
                                                                 
                                                                    <select name="id_chercheur" class="form-control" >
                                                                    <c:forEach var="u" items = "${chercheurSansEq}">
																			<option value ="${u.getId_chercheur()}">${u.getPrenom_chercheur()} ${u.getNom_chercheur()} 
