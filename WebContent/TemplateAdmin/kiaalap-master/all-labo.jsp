                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            <h4>Liste des laboratoires</h4>

                            <div class="add-product">
                                <a href="add-labo.jsp">Ajouter un laboratoire</a>
                            </div>
                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <tr>
                                        	...
                                        	<tbody>
                                        		<c:forEach items="${labos}" var="e">
                                        		<c:set var ="count" value="${count + 1}" scope = "page"/>
                                       			 <tr>
                                        
                                        <td>${count}</td>
                                        <td><a href ="allEquipeLabo.php?id_labo=${e.getId_labo()}">${e.getNom_labo()}</a></td> 
                                        
                                        <td>
                                       <a href ="editLabo.php?id_labo=${e.getId_labo()}">
                                            <button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                        </a>
                                        <a href ="deleteLabo.php?id_labo=${e.getId_labo()}">
                                            <button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                       </a>
                                        </td>
                                        <td>
                                        
                                       <a href="ajouterAUnLabo.php?id_labo=${e.getId_labo()}">
                        <button class="button button2">Ajouter une equipe</button>
                        </a>
                        <style>
                        .button {
  border: none;
