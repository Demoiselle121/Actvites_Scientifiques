                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            <h4>Liste des axes de recherche </h4>

                            <div class="add-product">
                                <a href="add-axeR.jsp">Ajouter un axe de recherche</a>
                            </div>
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <tr>
                                        	...
                                        	<tbody>
                                        		<c:forEach items="${Axe_recherche}" var="e">
                                        ...
                                        <td>${e.getNom_axe()}</td>
                                         ...
                                         <td>
                                        <a href ="editAxeR.php?id_axe=${e.getId_axe()}">
                                            <button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                        </a>
                                        <a href ="deleteAxeR.php?id_axe=${e.getId_axe()}">
