                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            <h4>Liste des equipes par laboratoire </h4> 
                              ...
                              <div class="asset-inner">
                                <table>
                                    <tr>
                                        ...
                                        <th style = "width:10%">Nom d'equipe</th>
                                    ...
                                    <tr>
                                        	...
                                        	<tbody>
                                        		<c:forEach items="${equipes}" var="q">
                                        		<c:set var ="count" value="${count + 1}" scope = "page"/>
                                       			 <tr>
                                        
                                        <td>${count}</td>
                                       
                                        <td>${q.getNom_equipe()}</td>
                                        
                                        
                                         <td>
                                       
                                    
                                        <a href ="deleteEquipeLabo.php?id_equipe=${q.getId_equipe()}">
