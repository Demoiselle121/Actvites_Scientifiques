                        ...
                        <div class="product-payment-inner-st">
                            ...
                            <div id="myTabContent" class="tab-content custom-product-edit">
                                <div class="product-tab-list tab-pane fade active in" id="description">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <form action ="addEquipe1.php" method = "post">
                                            <div class="review-content-section">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="nom_equipe" type="text" class="form-control" placeholder="Nom de l'equipe ">
                                                                </div>
                                                               
                                                                
                                                                <div class="form-group">
                                                                    <input name="ACRO_equipe" type="text" class="form-control" placeholder="Acro de l'equipe ">
                                                                </div>
                                                           ...
                                                           <%--  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="nom_labo" class="form-control">
																			<c:forEach items="${labos}" var="p">
																			<option value="${p.getId_labo()}">${p.getNom_labo()}</option>
																			</c:forEach>
																		</select>
                                                                </div>
