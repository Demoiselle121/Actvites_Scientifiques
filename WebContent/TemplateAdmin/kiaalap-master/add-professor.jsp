                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form action="addProfessor1.php" method = "POST" >
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            
                                                                <div class="form-group">
                                                                    <input name="nom_chercheur" type="text" class="form-control" placeholder="Nom du chercheur">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="prenom_chercheur" type="text" class="form-control" placeholder="Prenom du chercheur">
                                                                </div>
                                                                 <div class="form-group">
                                                                    <input type="text" class="form-control" name="email_chercheur" placeholder="Email"   required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="tel_chercheur" type="number" class="form-control" placeholder="Phone">
                                                                </div>
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group" >
                                                                    ...
                                                                    <select name="responsablite_chercheur" class="form-control" >
																			...
																			<option>chef d'un labo</option>
																			<option>Membre de conseil d'etablissement</option>
																			<option>Membre de conseil d'université</option>
																		</select>
                                                                </div>
                                                                 <div class="form-group">
