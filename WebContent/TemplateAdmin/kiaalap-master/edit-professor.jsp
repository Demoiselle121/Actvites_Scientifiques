...
<head>
    ...
    <title>Add Professor | Bachelor - Bachelor Admin </title>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form action="updateProfessor.php" method = "POST"  enctype="multipart/form-data">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            
                                                                <div class="form-group">
                                                                    <input name="nom_chercheur" type="text" class="form-control" value="${chercheur_Model.getNom_chercheur()}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="prenom_chercheur" type="text" class="form-control" value="${chercheur_Model.getPrenom_chercheur()}">
                                                                </div>
                                                                 <div class="form-group">
                                                                    <input type="text" class="form-control" name="email_chercheur" value="${chercheur_Model.getEmail_chercheur()}">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="tel_chercheur" type="number" class="form-control" value="${chercheur_Model.getTel_chercheur()}">
                                                                </div>
                                                               
                  												<input name="id_equipe" type="hidden" class="form-control" value="${chercheur_Model.getId_equipe()}">
                  												 <input name="id_labo" type="hidden" class="form-control" value="${chercheur_Model.getId_labo()}">
                   												 <input name="id_chercheur" type="hidden" class="form-control" value="${chercheur_Model.getId_chercheur()}">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                 <div class="form-group" >
                                                                    ...
                                                                    <select name="responsablite_chercheur" class="form-control" >
																			<option>Prof</option>
                                                                 ...
                                                                 <div class="form-group">
                                                                      <select name="responsabilite_pedagogique_chercheur" class="form-control">
																			<option>Prof</option>
																			<option>Docteur</option>
																			<option>Doctorant</option>
																		</select>
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="type_chercheur" class="form-control">
																			<option>Prof</option>
																			<option>Docteur</option>
																			<option>Doctorant</option>
