                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Encadrements</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="asset-inner">
                                <table>
                                    <tr>
                                        ...
                                        <th style = "width:10%">Encadrent</th>
                                    ...
                                    <tr>
                                        	...
                                        	<tbody>
                                        		<c:forEach items="${encadrements}" var="e">
                                        		<c:set var ="count" value="${count + 1}" scope = "page"/>
                                       			 <tr>
                                        
                                        <td>${count}</td>
                                        <td>${e.getType_encadrement()}</td>
                                        <td>${e.getIntitule_encadrement()}</td>
                                        
                                        <td>${e.getNiveau_encadrement()}</td>
                                        <td>${cher.getNomChercheurParId(e.getId_chercheur()).getNom_chercheur()}</td>
                                        <td>${e.getDate_encadrement()}</td>
                                        <td><a href ="getFileEncad.php?id_encadrement=${e.getId_encadrement()}">Justificatif</a></td>
                                         <td>
                                        
                                        <a href ="deleteEncadrement.php?idEnca=${e.getId_encadrement()}">
