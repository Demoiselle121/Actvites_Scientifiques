                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Conferences</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <tr>
                                        	...
                                        	<tbody>
                                        		<c:forEach items="${conferences}" var="e">
                                        		<c:set var ="count" value="${count + 1}" scope = "page"/>
                                       			 <tr>
                                        
                                        <td>${count}</td>
                                        <td>${e.getType_conference()}</td>
                                        <td>${e.getIntitule_conference()}</td>
                                        <td>${e.getLieu_conference()}</td>
                                        <td>${e.getDate_conference()}</td>
                                        <td>${cher.getNomChercheurParId(e.getId_chercheur()).getNom_chercheur()}</td>
                                         <td><a href ="getFileConf.php?id_conference=${e.getId_conference()}">Justificatif</a></td>

                                        <td><a href ="getFileConf2.php?id_conference=${e.getId_conference()}">Conference</a></td>
                                       
                                         
                                         <td>
                                        
                                        <a href ="deleteConference.php?idConf=${e.getId_conference()}">
