                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form action="editProfessor1.php" method = "POST" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            
                                                                <div class="form-group">
                                                                    <input name="lieu_soutenance" type="text" class="form-control" placeholder="lieu_soutenance">
                                                                </div>
                                                ...
                                                <div class="col-sm-10"><input name="date_soutenance" type="date" id="date" name="date_soutenance" class="mb-2 form-control-lg form-control"></div>
                                                                ...
                                                                <div class="form-group alert-up-pd">
                                                                    <div class="dz-message needsclick download-custom">
                                                                        ...
                                                                        <input name="justificatif_soutenance" class="hd-pro-img" type="text" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                 <div class="form-group" >
                                                                   ...
                                                                   <select name="nom_chercheur" class="form-control">
                                                                            <c:forEach items="${professeurs_docteurs}" var="r">
                                                                            <option value="${r.getId_chercheur()}">${r.getNom_chercheur()}</option>
                                                                            </c:forEach>
                                                                        </select>
                                                                </div>
                                                                 <div class="form-group">
                                                                   <select name="intitule_soutenance" class="form-control">
                                                                            <c:forEach items="${IntituSout}" var="e">
                                                                ...
                                                                <div class="form-group">
                                                                      <select name="type_chercheur" class="form-control">
																			<c:forEach items="${type_chercheur}" var="z">
