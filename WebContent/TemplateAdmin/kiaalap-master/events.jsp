                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                                ...
                                                <li><a href="edit-student.jsp">Modifier un docteur</a>
                                                </li>
                                                <li><a href="edit-student.jsp">Supprimer un docteur</a>
                                                </li>
                                                <li><a href="student-profile.jsp">Profil du docteur</a>
                                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                                ...
                                                <li><a href="add-student.jsp">Ajouter doctorant</a>
                                                </li>
                                                <li><a href="edit-student.jsp">Modifier un doctorant</a>
                                                </li>
                                                <li><a href="edit-student.jsp">Supprimer un doctorant</a>
                                                </li>
                                                <li><a href="student-profile.jsp">Profil du doctorant</a>
                                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a href="all-conference.jsp">Tous les Conferences</a>
                                                ...
                                                <li><a href="add-conference.jsp">Modifier une Conference</a>
                                                </li>
                                                <li><a href="edit-conference.jsp">Supprimer une Conference</a>
                                                </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                               <li><a href="departments.jsp">Tous les Encadrements</a>
                                                ...
                                                <li><a href="edit-encadrement.jsp">Supprimer Encadrement</a>
                                                </li>
                            </ul>
                        </li>
                         <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a href="departments.jsp">Liste des axes</a>
                                                ...
                                                <li><a href="edit-axeREquipe.jsp">Supprimer un axe</a>
                                                </li>
                            </ul>
                        </li>
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                               <li><a href="departments.jsp">Liste des axes</a>
                                                ...
                                                <li><a href="edit-axeRLabo.jsp">Supprimer un axe</a>
                                                </li>
                            </ul>
                        </li>
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a href="departments.jsp">Liste des Equipes</a>
                                                ...
                                                <li><a href="edit-equipe.jsp">Supprimer une equipe</a>
                                                </li>
                            </ul>
                        </li>
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a href="departments.jsp">Liste des Laboratoires</a>
                                                ...
                                                <li><a href="edit-department.jsp">Supprimer un Laboratoire</a>
                                                </li>
                            </ul>
                        </li>
                        <li class="active">
