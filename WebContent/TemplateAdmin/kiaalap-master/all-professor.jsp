                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Professeur</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            <h4>Liste des chercheurs</h4>

                            <div class="add-product">
                                <a href="addProfessor.php">Ajouter un chercheur</a>
                            </div>
                              <a href ="pdf.php">
                            ...
                            <div class="asset-inner">
                                <table>
                                    <tr>
                                        ...
                                        <th style = "width:10%">Responsabilité</th>
                                        <th style = "width:10%">Responsabilité pedagogique</th>
                                    ...
                                    <tr>
                                        	...
                                        	<tbody>
                                        		<c:forEach items="${chercheurs}" var="q">
                                        		<c:set var ="count" value="${count + 1}" scope = "page"/>
                                       			 <tr>
                                        
                                        <td>${count}</td>
                                        <td>${q.getPrenom_chercheur()}</td>
                                        <td>${q.getNom_chercheur()}</td>
                                        <td>${q.getType_chercheur()}</td>
                                        <td>${q.getEmail_chercheur()}</td>
                                        <td>${q.getTel_chercheur()}</td>
                                        <td>${q.getResponsablite_chercheur()}</td>
                                        <td>${q.getResponsabilite_pedagogique_chercheur()}</td>
                                       <%--  <td>${e.getNomEquipeParId(q.getId_equipe()).getNom_equipe()}</td> --%>
                                      
                                        <%--  <td>
                                        <a href ="editProfessor.php?id_chercheur=${q.getId_chercheur()}&id_equipe=${q.getId_equipe()}&id_labo=${q.getId_labo()}">
                                            <button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                        </a>
                                        <a href ="deleteProfessor.php?id_chercheur=${q.getId_chercheur()}">
                                            <button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                       </a>
                                        </td> --%>
                                        
                                          <td>
                                        <a href ="editProfessor.php?id_chercheur=${q.getId_chercheur()}">
                                            <button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                        </a>
                                        <a href ="deleteProfessor.php?id_chercheur=${q.getId_chercheur()}">
                                            <button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
