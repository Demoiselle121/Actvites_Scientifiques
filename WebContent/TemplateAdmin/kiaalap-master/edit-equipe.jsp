                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="nom_equipe" type="text" class="form-control" value ="${equipeModel.getNom_equipe()}">
                                                                </div>
                                                               
                                                                
                                                                <div class="form-group">
                                                                    <input name="ACRO_equipe" type="text" class="form-control" value ="${equipeModel.getACRO_equipe()}">
                                                                </div>
                                                                 
                                                                
                                                               <input name="id_equipe" type="hidden" class="form-control" value="${equipeModel.getId_equipe()}">
                  												 <input name="id_labo" type="hidden" class="form-control" value="${equipeModel.getId_labo()}">
                   												 <input name="id_chercheur" type="hidden" class="form-control" value="${equipeModel.getId_chercheur()}">
