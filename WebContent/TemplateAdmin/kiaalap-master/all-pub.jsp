                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Publications</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="asset-inner">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>${count}</td>
                                        <td>${q.getTitre_pub()}</td>
                                        <td>${q.getDate_publication()}</td>
                                       
                                        <td>${e.getNomChercheurParId(q.getId_chercheur()).getNom_chercheur()}</td> 
                                        <td><a href ="getFilePub.php?id_pub=${q.getId_pub()}">Justificatif</a></td>
</td>
                                        <td><a href ="getFilePub2.php?id_pub=${q.getId_pub()}">Publication</a></td>
                                       
                                         <td>
                                       
                                        <a href ="deletePub.php?id_pub=${q.getId_pub()}">
