                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                 ...
                                 <li><a href="delete-professor.jsp">Supprimer un professeur</a> </li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                               					<li><a href="all-students.jsp">Tous les docteurs</a>
                                                </li>
                                                <li><a href="add-student.jsp">Ajouter docteurs</a>
                                                </li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                               					<li><a href="all-students.jsp">Tous les doctorants</a>
                                                </li>
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a href="library-assets.jsp">Tous les Conferences</a>
                                                </li>
                        ...
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                               <li><a href="departments.jsp">Liste des Projet de recherche</a>
                                                ...
                                                <li><a href="delete-department.jsp">Supprimer Projet de recherche</a>
                                                </li>
                            </ul>
                        </li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demoevent" href="#">Professeurs <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demoevent" class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="delete-professor.jsp">Supprimer un professeur</a>
                                                </li>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#democrou" href="#">Doctorants <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="democrou" class="collapse dropdown-header-top">
                                                <li><a href="all-doctorants.jsp">Tous les doctorants</a>
                                                </li>
                                                <li><a href="add-course.jsp">Ajouter un doctorant</a>
                                                </li>
                                                <li><a href="edit-doctorant.jsp">Modifier un doctorant</a>
                                                </li>
                                                <li><a href="delete-doctorant.jsp">Supprimer un doctorant</a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demolibra" href="#">Conference <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demolibra" class="collapse dropdown-header-top">
                                                <li><a href="all-Conferences.jsp">Toutes les Conferences</a>
                                                </li>
                                                <li><a href="add-Conference.jsp">Ajouter une Conference</a>
                                                </li>
                                                <li><a href="edit-Conference.jsp">Modifier une Conference</a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demodepart" href="#">Soutenance <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demodepart" class="collapse dropdown-header-top">
                                                <li><a href="departments.jsp">Toutes les Soutenances</a>
                                                </li>
                                                <li><a href="add-department.jsp">Ajouter une Soutenance</a>
                                                </li>
                                                <li><a href="edit-department.jsp">Modifier une Soutenance</a>
                                                </li>
                                                <li><a href="edit-department.jsp">Supprimer une Soutenance</a>
                                                </li>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demodepart" href="#">Encadrement <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demodepart" class="collapse dropdown-header-top">
                                                <li><a href="all-Encadrements.jsp">Tous les Encadrements</a>
                                                </li>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demodepart" href="#">Laboratoires<span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                         ...
                                         <li><a data-toggle="collapse" data-target="#demodepart" href="#">Projet de recherche<span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demodepart" class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="add-Projet_recherche.jsp">Ajouter un projet de recherche</a>
                                                </li>
                                                <li><a href="add-Projet_recherche.jsp">Modifier un projet de recherche</a>
                                                </li>
                                                <li><a href="edit-Projet_recherche.jsp">Supprimer un projet de recherche</a>
                                                </li>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <form  action="updateAxeRLabo.php"  method="post">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <input name="nom_axe_recherche_labo" type="text" class="form-control" value="${AxeRLaboModel.getNom_axe_recherche_labo()}">
                                                            </div> 
                                                            
                                                             <input name="id_axe_recherche_labo" type="hidden" class="form-control" value="${AxeRLaboModel.getId_axe_recherche_labo()}">
                                                        </div>
