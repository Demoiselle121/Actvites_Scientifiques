                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Equipe</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            ...
                            <div class="add-product">
                                <a href="addEquipe.php">Ajouter une equipe</a>
                            </div>
                            ...
                            <div class="asset-inner">
                                <table>
                                    <tr>
                                        ...
                                        <th style = "width:10%">Acro</th>
                                        <th style = "width:10%">chef d'equipe</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>${count}</td>
                                        <td><a href ="allChercheurEquipe.php?id_equipe=${e.getId_equipe()}">${e.getNom_equipe()}</a></td> 
                                        <td>${e.getACRO_equipe()}</td>
                                        <td>${q.getNomChercheurParId(e.getId_chercheur()).getNom_chercheur()}</td>
                                        
                                         <td>
                                        <a href ="editEquipe.php?id_equipe=${e.getId_equipe()}&id_chercheur=${e.getId_chercheur()}&id_labo=${e.getId_labo()}">
                                            <button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                        </a>
                                        <a href ="deleteEquipe.php?id_equipe=${e.getId_equipe()}">
                                       ...
                                       <a href="ajouterAUneEquipe.php?id_equipe=${e.getId_equipe()}">
                        <button class="button button2">Ajouter un chercheur</button>
                        </a>
                        <style>
                        .button {
  border: none;
...
.button2:hover {
  ...
  color: white;
                                       ...
                                       <a href="addAxeREquipe2.php?id_equipe=${e.getId_equipe()}">
                        <button class="button button2">Ajouter un axe de recherche</button>
                        </a>
                        <style>
                        .button {
  border: none;
