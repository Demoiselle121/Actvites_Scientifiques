                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <form  action="updateAxeR.php"  method="post">
                                                    <div class="row">
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <input name="nom_axe" type="text" class="form-control" value="${AxeRModel.getNom_axe()}">
                                                            </div> 
                                                            
                                                             <input name="id_axe" type="hidden" class="form-control" value="${AxeRModel.getId_axe()}">
                                                        </div>
