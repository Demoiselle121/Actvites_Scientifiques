...
<head>
    ...
    <title>Ajouter un Encadrement | Bachelor - Bachelor Admin</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">encadrement</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form action="addEncadrement1.php" method = "post" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <select name="type_encadrement" class="form-control">
                                                                            <c:forEach items="${typeEnca}" var="p">
                                                                 ...
                                                                 <div class="form-group">
                                                                    <select name="encadrement" class="form-control">
                                                                            <c:forEach items="${Encadrement}" var="e">
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="intitule_encadrement" class="form-control">
                                                                            <c:forEach items="${IntiEnca}" var="e">
                                                                             <option value="${e}">${e}</option>
                                                                             </c:forEach> 
                                                                        </select>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                 <div class="form-group">
                                                                    <select name="niveau_encadrement" class="form-control">
                                                                             <c:forEach items="${nivEncad}" var="r">
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="NOM_chercheur" class="form-control">
                                                                            <c:forEach items="${chercheurs}" var="r">
