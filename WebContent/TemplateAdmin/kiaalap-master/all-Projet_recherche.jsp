                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li class="active">
                            <a class="has-arrow" href="all-courses.jsp" aria-expanded="false"><span class="educate-icon educate-department icon-wrap"></span> <span class="mini-click-non">Axe Labo</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                               <li><a href="allAxeREquipe.php">Liste des axes</a>
                                                </li>
                                                <li><a href="addAxeREquipe.php">Ajouter un axe</a>
                                                </li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Projet de recherche</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap drp-lst">
                            <h4>Liste des Projets de recherche</h4>
                            ...
                            <div class="asset-inner">
                                <table>
                                    <tr>
                                        ...
                                        <th style = "width:10%">Titre du projet</th>
                                        <th style = "width:10%">description du projet</th>
                                        <th style = "width:10%">Budget du projet</th>
                                        <th style = "width:10%">Justificatif</th>
                                    ...
                                    <tr>
                                        	...
                                        	<tbody>
                                        		<c:forEach items="${projetDRecherche}" var="e">
                                        		<c:set var ="count" value="${count + 1}" scope = "page"/>
                                       			 <tr>
                                        
                                        <td>${count}</td>
                                        <td>${e.getTitre_projet_recherch()}</td>
                                        <td><a href ="description.jsp">voir la description</a></td>
                                        <td>${e.getBudget_projet_recherche()}</td>
                                        <td><a href ="justificatif_projet.jsp">voir le justificatif</a></td>
                                        <td>${cher.getNomChercheurParId(e.getId_chercheur()).getNom_chercheur()}</td>
                                       
                                         <td>
                                        
                                        <a href ="deleteProjetDRecherche.php?idProjet=${e.getId_projet_recherche()}">
