...
public class PDFPub {
	...
	public PDFPub(List<Publication> listPub) {
		super();
		this.listPub = listPub;
	}

	public List<Publication> getListPub() {
		return listPub;
	}

	public void setListPub(List<Publication> listPub) {
		this.listPub = listPub;
	}
	private void writeTableHeader(PdfPTable table) {
        ...
        cell.setPhrase(new Phrase("abstract", font));
        table.addCell(cell);
        ...
        cell.setPhrase(new Phrase("Nom de l'auteur", font));
        table.addCell(cell);
	...
	private void writeTableData(PdfPTable table) {
        for (Publication user : listPub) {
            table.addCell(user.getTitre_pub());
            table.addCell(user.getAbstract_pub());
            table.addCell(user.getType_publication());
            table.addCell(user.getD());
            table.addCell(chercheur_data_base.getCherchParId(user.getId_chercheur()).getNom_chercheur());
        }
    }
